...
public class TestEquipUI 
{
	public static void main(String args[])
	{
	    ...
	    TwoHanded battleaxe5 = new TwoHanded(10.0, 4000, "Battle Axe +5", 2, 10, 0, 0, 5, 5, "none", 0);
	    ...
	    inventory.lootItem(battleaxe5);
	    inventory.lootItem(longSword);
	    inventory.lootItem(shortSword);
	    inventory.lootItem(skullCap);
	    inventory.lootItem(spikedShoulder);
	    inventory.lootItem(chainmail);
	    inventory.lootItem(chainGloves);
	    inventory.lootItem(chainPants);
	    inventory.lootItem(chainBoots);
	    inventory.lootItem(moreBoots);
	    @SuppressWarnings("unused")
		EquipUI equipMe = new EquipUI(equipment, inventory);
	    equipMe = null;
	} 
}
