...
public class ItemDeprecated
{
     ...
     */
    public ItemDeprecated(int damageMin, int damageMax, int def, String type, String effect,int effectValue, String name)
    {
        damage = new int[2];
        equipSpots = new ArrayList<String>();
