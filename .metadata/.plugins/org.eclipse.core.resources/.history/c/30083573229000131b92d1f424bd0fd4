 ...
 * @version (0.1_3)
 */
public class MonsterDeprecated
{
     ...
     */
    public MonsterDeprecated(String name, int armor, int level, int hpDie, int dmgMin, int dmgMax, 
    ...
    /**
     * sets the XP Value of the monster with the parameters MIN_DIFF and MAX_DIFF
     * @param int - difficulty
     */
