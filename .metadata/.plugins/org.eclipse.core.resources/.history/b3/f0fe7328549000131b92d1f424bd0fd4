 ...
 * @version (0.1_3)
 */
public class PlayerCharacterDeprecated
{
     ...
     */
    public PlayerCharacterDeprecated()
    {
        hp = new int[2];
        mp = new int[2];
        xp = new int[2];
     ...
     */
    public PlayerCharacterDeprecated(String name, int age, int str, int dex, int con, int intel, int wis, int chr)
    {
        hp = new int[2];
        mp = new int[2];
        xp = new int[2];
